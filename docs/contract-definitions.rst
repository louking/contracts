...
.. glossary::
    ...
    state
        ...
        The transition from *pending* to *tentative* is done by the admin using the :ref`create-
        event-view` or :ref:`edit-event-view`. This should be used to help remember which races have
