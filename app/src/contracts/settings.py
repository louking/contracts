...
class Testing(Config):
    ...
    # required by create_app() to look up the Application row for g.loutility, normally supplied by config/contracts.cfg
    ...
    # loutilities.user.model.Application/User/Role live in the 'users' bind in production (see RealDb);
    # point it at the same in-memory sqlite db used for SQLALCHEMY_DATABASE_URI above
    SQLALCHEMY_BINDS = {
        'users': 'sqlite:///:memory:'
    }
