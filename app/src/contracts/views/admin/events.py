...
event_view = EventsContract(
                    ...
                    clientcolumns = [
                        ...
                        { 'data': 'mainDistance', 'name': 'mainDistance', 'label': 'Distance',
                          'className': 'field_req field_show_basic field_show_scoring field_show_chiptiming field_show_coursemarking table_hide',
                        },
                        { 'data': 'mainDistanceUnits', 'name': 'mainDistanceUnits', 'label': 'Units', 'type': 'select2', 
                          'className': 'inhibitlabel field_show_basic field_show_scoring field_show_chiptiming field_show_coursemarking table_hide', 
                          'options':['M', 'km'], 
                          'ed':{ 'def':'km' }, 
                          'opts' : { 'minimumResultsForSearch': 'Infinity' },
                        },
                        { 'data': 'funStartTime', 'name': 'funStartTime', 'label': 'Fun Run Start Time', 
                          'className': 'field_show_basic field_show_scoring field_show_chiptiming field_show_coursemarking table_hide', 
                          'type':'datetime', 'ed':{'format':'h:mm a', 'opts':{ 'momentStrict':True, 'minutesIncrement':15 }}, 
                        },
                        ...
                        { 'data': 'lead', 'name': 'lead', 'label': 'Lead', 
                          'className': 'field_req field_show_basic field_show_scoring field_show_chiptiming ', 
