...
def upgrade():
    ...
    op.alter_column('sponsor', 'isLogoReceived',
               ...
               type_=sa.Boolean(),
               existing_nullable=True)
    op.alter_column('sponsor', 'isRegSiteUpdated',
               existing_type=mysql.TINYINT(display_width=1),
               type_=sa.Boolean(),
               existing_nullable=True)
    ...
    op.alter_column('sponsor', 'isWebsiteUpdated',
               ...
               type_=sa.Boolean(),
               existing_nullable=True)
    op.add_column('sponsorbenefit', sa.Column('race_id', sa.Integer(), nullable=True))
    ...
    op.alter_column('sponsorrace', 'isRDCertified',
               ...
               type_=sa.Boolean(),
               existing_nullable=True)
    op.add_column('sponsorracedate', sa.Column('beneficiary', sa.String(length=128), nullable=True))
...
def downgrade():
    ...
    op.alter_column('tag', 'isBuiltIn',
               ...
               type_=mysql.TINYINT(display_width=1),
               existing_nullable=True)
    op.drop_column('sponsorracedate', 'raceloc')
    op.drop_column('sponsorracedate', 'beneficiary')
    op.alter_column('sponsorrace', 'isRDCertified',
               existing_type=sa.Boolean(),
               type_=mysql.TINYINT(display_width=1),
               existing_nullable=True)
    ...
    op.drop_column('sponsorbenefit', 'race_id')
    op.alter_column('sponsor', 'isWebsiteUpdated',
               existing_type=sa.Boolean(),
               type_=mysql.TINYINT(display_width=1),
               existing_nullable=True)
